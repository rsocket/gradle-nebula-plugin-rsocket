 ...
 */
class RSocketOsgiPlugin implements Plugin<Project> {
        ...
        project.tasks.matching { it.name == 'jar' }.all { Jar jarTask ->
            project.plugins.withType(JavaPlugin) {
                ...
                jarTask.manifest {
                    ...
                    manifest.instruction 'Bundle-Vendor', 'RSocket'
                    manifest.instruction 'Bundle-DocURL', 'https://github.com/RSocket'
